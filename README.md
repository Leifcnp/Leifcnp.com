...
See [PLAN.md](PLAN.md), the canonical [to-do list](WEBSITE_TODO.md), and the per-task `plans/WEB-NNN/plan.md` files. Stop after Phase 10 for drawer review. WEB-016 submenu harbours is next queued; incoming-wave variation/direction (WEB-017), wind streams/flags/spray (WEB-019), auto-trim/manual boost (WEB-020) and stronger reach heel/railwash (WEB-021) remain future tasks.
