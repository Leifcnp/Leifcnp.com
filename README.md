...
See [PLAN.md](PLAN.md), the canonical [to-do list](WEBSITE_TODO.md), and the per-task `plans/WEB-NNN/plan.md` files. Stop after Phase 11 for sailing-feel review. On 2026-09-25 the user deferred WEB-016 harbours/zoom to prioritize boat feel. WEB-020 is the active phase; stronger reach heel/railwash (WEB-021), wind streams/flags/spray (WEB-019), incoming-wave variation/direction (WEB-017) and shoreline interaction (WEB-022) are related backlog tasks.
